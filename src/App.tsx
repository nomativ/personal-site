...
function App() {
  ...
  return (
    <>
    <Header />
    <div className="w-[470px] p-3 bg-[#173253] rounded-[30px] flex-col justify-start items-start gap-4 inline-flex">
    ...
    <div className="px-2 pb-1 justify-between items-center inline-flex">
