...
// Toggle between job-seeking and employed modes
const HIRING_MODE = false
              ...
              <div className="flex-col justify-start items-start gap-6 flex">
                <div className="flex-col justify-start items-start flex w-full">
                  {HIRING_MODE
                    ...
                    : <div className="text-white/50 text-2xl text-center md:text-left w-full">TRM Labs</div>
                  }
                  {HIRING_MODE
                    ...
                    : <div className="text-white/90 md:text-[40px] text-[32px] font-semibold tracking-tight leading-[40px] text-center md:text-left w-full">Lead product designer</div>
                  }
                </div>
                <Divider />
                ...
                <div className="text-white text-base font-medium text-center md:text-left">
                  {HIRING_MODE
                    ? "Throughout my career, I've turned complex product challenges into thoughtfully crafted solutions that look beautiful, feel natural, and are useful for everyone."
                    : "Building the design×AI flywheel to ship product faster. Top 10% AI practitioner driving design initiatives at TRM."}
                </div>
                <div className="flex flex-col md:flex-row gap-4 md:gap-0 items-center w-full">
                  {HIRING_MODE ? (
                    ...
                    <>
                      <Button text="Reach out" url="mailto:toedgar@pm.me" />
                      <Link text="LinkedIn" url="https://www.linkedin.com/in/edpriday/" newTab={true} />
                    </>
                  )}
                </div>
        ...
        >
          ...
          <div className='w-full inline-flex items-center justify-between py-6'>
            ...
            <div className="text-white md:text-base text-sm flex items-center gap-4 w-fit">
              ...
              {HIRING_MODE && <Link text="See my resume" url="https://edgar-p.notion.site/" />}
            </div>
          </div>
        </motion.div>
      </motion.main >
